...
export function AnimatedBackground() {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden">
      ...
      <motion.div
        className="absolute -top-20 -left-40 h-[24rem] w-[24rem] rounded-full blur-3xl bg-primary/50" // <-- Opasitas Ditingkatkan (50%)
        animate={{
          x: [0, 60, 0],
          y: [0, 80, 0],
          scale: [1, 1.15, 1],
      ...
      />
      <motion.div
        className="absolute -bottom-40 -right-20 h-[30rem] w-[30rem] rounded-full blur-3xl bg-accent/30" // <-- Diganti ke Accent/30
        animate={{
          x: [0, -70, 0],
          y: [0, -90, 0],
          scale: [1.1, 1, 1.1],
