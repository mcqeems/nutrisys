...
import { Activity, Bell, BookOpenText, Bot, Target, WandSparkles, ClipboardList } from 'lucide-react';
...
const mainFeatures = [
  ...
  },
  {
    ...
    link: 'journal',
    icon: BookOpenText,
    benefits: ['Pelacakan Kebiasaan', 'Pencatatan Suasana Hati', 'Analitik Kemajuan'],
  },
  {
    id: 4,
    title: 'Target Cerdas',
...
export function FeatureShowcase() {
  ...
  return (
    <div className="w-full">
      <HeroSection />
      {/* main feature  */}
      <section id="features" className="pb-20 px-4 bg-linear-to-b from-background via-background to-background">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-24">
            <div className="text-center mb-12">
              <h3 className="text-3xl md:text-4xl font-bold mb-3">Pengalaman yang Ditingkatkan</h3>
