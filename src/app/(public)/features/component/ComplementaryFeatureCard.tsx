...
export function ComplementaryFeatureCard({ feature }: ComplementaryFeatureCardProps) {
  return (
    <div className="group relative overflow-hidden rounded-2xl bg-card border border-border/40 transition-all duration-500 hover:shadow-2xl hover:border-primary/50 h-full">
      ...
      <div className="relative p-8 h-full flex flex-col">
        ...
        <p className="text-muted-foreground mb-6 grow leading-relaxed">{feature.description}</p>
